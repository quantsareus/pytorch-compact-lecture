...
model= nn.Sequential(
    ...
    OrderedDict([
        ('input_linear', nn.Linear(1, no_neurons)),
        ('hidden_activation', nn.Tanh()),
        ('output_linear', nn.Linear(no_neurons, 1)),
        ])
    )
...
# 5. show results
# print the parameters from the ordered dict model 
print("")
print("input weight", model.input_linear.weight)
print("")
print("input bias", model.input_linear.bias)
print("")
print("output weight", model.output_linear.weight)
print("")
print("output bias", model.output_linear.bias)
...
# 6.save the model
"""
# Save and load a model without any changes in its structure
